-- 024_notifications_withdrawal_policy_alignment.sql
-- Purpose:
-- 1) Ensure legacy notification relation columns exist in all environments.
-- 2) Align notification INSERT policy with current MVP event types.
