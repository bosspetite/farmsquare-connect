        ...
        <div className="farm-card">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Field Agent Account</p>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="px-3 py-1 rounded-full text-xs font-medium bg-farm-success/10 text-farm-success mt-1 inline-block">
                    Verified
                  </span>
                </div>
              </div>
        ...
        <div className="farm-card">
          ...
          <div className="space-y-3 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-medium text-foreground">Field Agent</span>
            </div>
            <div className="flex justify-between">
