    ...
    return (
        <div className="min-h-screen bg-[#FAFAFA]">
            ...
            <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-200">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex items-center justify-between min-h-[52px]">
                    <Link to="/" className="flex items-center gap-2 sm:gap-3">
                        <img
                            ...
                            fetchPriority="high"
                        />
                        <span className="font-display font-bold text-lg sm:text-xl text-gray-900 leading-none">
                            FarmSquare
                        </span>
                    </Link>
                    ...
                    <nav className="hidden md:flex items-center gap-6">
                        <Link
                            to="/how-it-works"
                            className="text-sm text-gray-600 hover:text-[#22C55E] transition-colors duration-300"
                        >
                            How it Works
                        </Link>
                        <Link
                    ...
                    <Link
                        to="/auth"
                        className="px-4 py-2 sm:px-5 sm:py-2.5 bg-[#22C55E] text-white rounded-lg text-sm font-medium hover:bg-[#16A34A] transition-colors min-w-[110px] text-center"
                    >
                        Get Started
                    </Link>
                </div>
            ...
            <section className="relative min-h-screen overflow-hidden">
                ...
                <div className="relative z-10 h-full flex items-center justify-center">
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-[88px] sm:pt-[96px] pb-16 sm:pb-20">
                        <div className="max-w-3xl mx-auto text-center px-4 md:px-0">
                            {/* Badge */}
                            <div className="inline-flex items-center gap-2 px-4 py-2 sm:px-5 sm:py-2.5 bg-white/95 backdrop-blur-sm border border-white/20 rounded-full text-[#166534] text-sm font-semibold mb-6 sm:mb-10 shadow-lg mx-auto max-w-full">
                                Nigeria's B2B Agro Marketplace
                            </div>

                            {/* Main Headline */}
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-4 sm:mb-6 leading-tight sm:leading-[1.05] drop-shadow-2xl">
                                Connect. Trade. Grow.
                            </h1>

                            {/* Subheadline */}
                            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-white/95 max-w-3xl mx-auto mb-8 sm:mb-10 leading-relaxed drop-shadow-lg">
                                The trusted marketplace connecting Nigerian
                                farmers directly with buyers. Quality-graded
                                produce, secure payments, reliable logistics.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                                <Link
                                    ...
                                    className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-[#22C55E] text-white rounded-xl text-sm sm:text-base font-semibold hover:bg-[#16A34A] transition-all flex items-center justify-center gap-2 shadow-xl hover:shadow-2xl transform hover:-translate-y-1"
                                >
                                    Start Selling
                                ...
                                <Link
                                    ...
                                    className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-white/95 backdrop-blur-sm border-2 border-white/30 text-gray-900 rounded-xl text-sm sm:text-base font-semibold hover:bg-white transition-all flex items-center justify-center gap-2 shadow-xl hover:shadow-2xl"
                                >
                                    Buy Produce
                                </Link>
                            </div>
                ...
                <div className="container mx-auto">
                    <div className="text-center mb-14 md:mb-20">
                        ...
                        <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
                            Browse quality-graded produce available for bulk
                            purchase from verified farmers
                        </p>
                    </div>
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-5 md:gap-6">
                        {featuredProduce.map((produce, i) => (
                            <div
                                key={i}
                                className="bg-white rounded-xl overflow-hidden border border-gray-200 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group"
                            >
                        ...
                        {[
                            {
                                ...
                                description:
                                    "Farmers upload their produce with quality grades and pricing. Field agents verify and grade each listing.",
                            },
                            {
                                step: "2",
                                icon: Users,
                                ...
                                description:
                                    "Buyers browse available produce, compare prices, and place orders. Secure escrow holds payment.",
                            },
                            {
                                step: "3",
                                icon: Truck,
                                ...
                                description:
                                    "Produce is delivered with full tracking. Payment is released after verified delivery.",
                            },
                        ].map((item, i) => (
                ...
                <div className="container mx-auto relative z-10">
                    <div className="text-center mb-20 md:mb-24">
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                            We've built the infrastructure to make agricultural
                            trade seamless, secure, and profitable for everyone.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                description:
                                    "Every produce is inspected and graded (A/B/C) by certified field agents.",
                            ...
                            },
                            {
                                ...
                                title: "Fair Pricing",
                                description:
                                    "Real-time market intelligence ensures you get competitive prices.",
                            ...
                            },
                            {
                                ...
                                description:
                                    "End-to-end tracking from farm to warehouse with our logistics network.",
                            ...
                            },
                            {
                                ...
                                description:
                                    "Funds are held securely and released only after verified delivery.",
                                gradient: "from-[#16A34A] to-[#22C55E]",
                                iconBg: "from-[#F0FDF4] to-[#BBF7D0]",
                                accent: "from-[#16A34A]/20 to-[#22C55E]/10",
                            },
                            ...
                            >
                                ...
                                <div
                                    className={`absolute inset-0 bg-gradient-to-br ${feature.accent} opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl`}
                                ></div>
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="relative mb-6">
                                        <div
                                            className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${feature.iconBg} flex items-center justify-center border-2 border-[#BBF7D0] shadow-lg group-hover:scale-110 group-hover:shadow-2xl transition-all duration-500 relative overflow-hidden`}
                                        >
                                            <feature.icon
                                                className={`w-10 h-10 ${feature.iconColor} z-10 relative`}
                                            />
                                    ...
                                    <div
                                        className={`absolute bottom-0 left-0 right-0 h-2 bg-gradient-to-r from-transparent via-[#22C55E] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-b-3xl`}
                                    ></div>
                                </div>

                                {/* Unique corner decorations */}
                                <div
                                    className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-br ${feature.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-500 rounded-bl-3xl`}
                                ></div>
                                <div
                                    className={`absolute bottom-0 left-0 w-20 h-20 bg-gradient-to-tr ${feature.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-500 rounded-tr-3xl`}
                                ></div>
                    ...
                    <div className="relative bg-gradient-to-br from-[#F0FDF4] via-white to-[#F0FDF4] border-2 border-[#BBF7D0] rounded-3xl p-10 md:p-14 lg:p-20 text-center max-w-5xl mx-auto shadow-2xl overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-xl md:text-2xl text-gray-700 max-w-3xl mx-auto mb-10 leading-relaxed">
                                Join thousands of farmers and buyers already
                                trading on FarmSquare. Start your journey today
                                and grow your agricultural business with
                                confidence.
                            </p>
            ...
            <section className="py-20 md:py-28 px-4 bg-gradient-to-b from-white via-[#FAFAFA] to-white relative overflow-hidden">
                ...
                <div className="container mx-auto relative z-10">
                    <div className="text-center mb-14 md:mb-20">
                        ...
                        <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto">
                            Real stories from farmers, buyers, and logistics
                            partners.
                        </p>
                    </div>
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-start gap-4 mb-5">
                                        <div
                                            className={`w-14 h-14 rounded-full bg-gradient-to-br ${testimonial.gradient} border-2 border-[#BBF7D0] flex items-center justify-center flex-shrink-0 shadow-sm group-hover:shadow-md transition-shadow duration-300`}
                                        >
                ...
                <div className="container mx-auto relative z-10">
                    <div className="text-center mb-14 md:mb-20">
                        ...
                        <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                            Working with trusted partners to build a stronger
                    ...
                    <div className="mt-12 text-center">
                        <p className="text-sm text-gray-600 mb-4">
                            Trusted by leading agricultural organizations across
                            Nigeria
                        </p>
                    ...
                    <div className="grid md:grid-cols-4 gap-8 mb-8">
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                <Link
                                    to="/how-it-works"
                                    className="block text-sm text-gray-600 hover:text-[#22C55E] transition-colors duration-300"
                                >
                                    How it Works
                                </Link>
                                <Link
